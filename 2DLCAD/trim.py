...
class TrimManager:
    ...
    def activate(self):
        ...
        if self.app.multi_selected:
            if len(self.app.multi_selected) != 1:
                try:
                    ...
                    messagebox.showinfo("Trim", "Please select exactly one line to trim.")
                except:
                    pass
                return False
            ...
            try:
                from tkinter import messagebox
                messagebox.showinfo("Trim", "Please select a line to trim first.")
            except:
                pass
            return False
        ...
        if self.line_length < 1e-6:
            try:
                from tkinter import messagebox
                messagebox.showinfo("Trim", "Selected line is too short to trim.")
            except:
                pass
            return False
    ...
    def _apply_trim(self):
        ...
        if abs(self.trim_point_1 - self.trim_point_2) < 1e-6:
            try:
                from tkinter import messagebox
                messagebox.showinfo("Trim", "Trim points are too close together.")
            except:
                pass
            return
